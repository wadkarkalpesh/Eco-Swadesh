...
const VERNACULAR_TRANSLATIONS = {
  hi: {
    ...
    sampleAudioUrl: 'https://cdn.deccanorigin.com/audio/advisory_hi_neem_tricho.mp3',
  ...
  pa: {
    ...
    sampleAudioUrl: 'https://cdn.deccanorigin.com/audio/advisory_pa_neem_tricho.mp3',
  ...
  mr: {
    ...
    sampleAudioUrl: 'https://cdn.deccanorigin.com/audio/advisory_mr_neem_tricho.mp3',
  ...
  te: {
    ...
    sampleAudioUrl: 'https://cdn.deccanorigin.com/audio/advisory_te_neem_tricho.mp3',
  ...
  ta: {
    ...
    sampleAudioUrl: 'https://cdn.deccanorigin.com/audio/advisory_ta_neem_tricho.mp3',
  ...
  en: {
    ...
    sampleAudioUrl: 'https://cdn.deccanorigin.com/audio/advisory_en_neem_tricho.mp3',
